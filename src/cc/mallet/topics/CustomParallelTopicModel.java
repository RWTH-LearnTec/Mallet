...
public class CustomParallelTopicModel implements Serializable {

	public static final int UNASSIGNED_TOPIC = -1;

	public static Logger logger = MalletLogger.getLogger(CustomParallelTopicModel.class.getName());
	...
	public CustomParallelTopicModel (int numberOfTopics) {
		this (numberOfTopics, numberOfTopics, DEFAULT_BETA);
	}
	
	public CustomParallelTopicModel (int numberOfTopics, double alphaSum, double beta) {
	...
	public CustomParallelTopicModel (LabelAlphabet topicAlphabet, double alphaSum, double beta) {
	...
	public static CustomParallelTopicModel read (File f) throws Exception {

		CustomParallelTopicModel topicModel = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
		topicModel = (CustomParallelTopicModel) ois.readObject();
		ois.close();
	...
	public static void main (String[] args) {
		...
		try {
			...
			CustomParallelTopicModel lda = new CustomParallelTopicModel (numTopics, 50.0, 0.01);
